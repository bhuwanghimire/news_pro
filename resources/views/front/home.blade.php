        ...
        <div class="row">
            <div class="col-md-6">
                <div class="top_article_img">
                    <a href="single.html" target="_self"><img class="{{asset('front/img/feature-static2.jpg')}}" alt="feature-top">
                    </a>
                </div>
                <!----top_article_img------>
            </div>
            ...
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{asset('front/img/feature-static2.jpg')}}
